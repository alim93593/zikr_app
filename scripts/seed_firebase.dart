...
Future<void> main() async {
  ...
  final morningAzkars = [
    ...
    {
      'text': 'اللَّهُمَّ إِنِّي أَصْبَحْتُ أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلائِكَتَكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللهُ لاَ إِلَـهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسُولُكَ',
      'count': 4,
  ...
  final eveningAzkars = [
    {
      'text': 'أَمْسَيْنَا وَأَمْسَى الْمُلْكُ للهِ، وَالْحَمْدُ للهِ، لاَ إِلَـهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيكَ لَهُ',
      'count': 1,
      'source': 'رواه مسلم',
    },
    {
    ...
    {
      'text': 'اللَّهُمَّ إِنِّي أَمْسَيْتُ أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلائِكَتَكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللهُ لاَ إِلَـهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ',
      'count': 4,
      'source': 'رواه أبو داود',
    },
    {
  ...
  final sleepAzkars = [
    {
      'text': 'بِاسْمِكَ رَبِّي تَوَضَّأْتُ وَبِاسْمِكَ أَرْجُو وَبِكَ أَثْبُتُ',
      'count': 1,
      'source': 'رواه أبو داود',
    },
    {
  ...
  final wakeUpAzkars = [
    ...
    {
      'text': 'لاَ إِلَـهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، سُبْحَانَ اللهِ وَالْحَمْدُ لِلَّهِ وَلاَ إِلَـهَ إِلاَّ اللهُ وَاللهُ أَكْبَرُ وَلاَ حَوْلَ وَلاَ قُوَّةَ إِلاَّ بِاللهِ الْعَلِيِّ الْعَظِيمِ',
      'count': 1,
      'source': 'رواه مسلم',
    },
    {
  ...
  final marketAzkars = [
    {
      'text': 'لاَ إِلَـهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، يُحْيِي وَيُمِيتُ، وَهُوَ حَيٌّ لاَ يَمُوتُ، بِيَدِهِ الْخَيْرُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ',
      'count': 1,
      'source': 'رواه أبو داود',
    },
  ];
  ...
  for (final category in categories) {
    ...
    for (final zikir in zikrs) {
      await firestore.collection('zikr_categories').doc(categoryId).collection('zikrs').add({
        'text': zikir['text'],
        'count': zikir['count'],
        'source': zikir['source'] ?? '',
        'createdAt': FieldValue.serverTimestamp(),
    ...
    print('Added category: ${category['name']} with ${zikrs.length} zikrs');
  }
